...
//import Sidebar from "@/app/components/ui/mih-sidebar";

const REQUIRED_ROLE = "Medicine Inventory Handler";
...
export default async function MIHLayout({ children }: { children: ReactNode }) {
